...
/**
 * qms4_detail() 関数の挙動をカスタマイズする関数
 *
 * qms4_detail() 関数はデフォルトでは QMS4\Item\Post\Post クラスのインスタンスを返すが、
 * これを変更できる
 *
 *
 * @example
 ...
 *     }
 *
 *     qms4_detail_set_item_class( CustomPost::class );
 *
 *     $param = array();
 ...
 */
function qms4_detail_set_item_class(
	string $class_name,
	$post_types = array()
): void
{
